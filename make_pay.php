...
<body onload="myfunction()">
    ...
    <div class="header" id="myheader">
        <div class="logoTitle">
            <div class="row">
                <div class=" col-md-3">
                    <img id="logo" src="ngologo.jpg" alt="Image not Found">
                </div>
                ...
                <div id="apnaCarousel" class="carousel slide" data-ride="carousel" data-interval="4000">
                    ...
                    <div class="carousel-inner">
                        <div class="item active">
                            <img src="galleryimage1.jpg"  alt="" style="width:100%;height:472px;opacity:0.7; ">
                            <div class="carousel-caption">
                                <h2>We Care-The every aspect of your life</h2>
                            </div>
                        </div>
                        <div class="item ">
                            <img src="galleryimage2.jpg"  alt="" style="width:100%;height:472px;opacity:0.7">
                            <div class="carousel-caption">
                                <h2>We Protect-The values of your life</h2>
                            </div>
                        </div>
                        <div class="item ">
                            <img src="galleryimage3.jpg"  alt="" style="width:100%;height:472px;opacity:0.7">
                            <div class="carousel-caption">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-3">
                        ...
                        <br><br><br><br><br><br>
                        <img src="image2.jpg" class="imageDiv">
                    </div>
                </div>   
            </div>
        </div>
        ...
        <div id="containerTab">
            <div id="box">
                <br>
                <center><img src="student.png" width="60px" height="60px"></img></center>
            ...
            <div id="box">
                <br>
                <center><img src="volunteer.png" width="60px" height="60px"></img></center>
            ...
            <div id="box">  
                <br>
                <center><img src="donation.png" width="60px" height="60px" ></img></center>
            ...
            <div id="box">  
                <br>
                <center><img src="solution.png" width="60px" height="60px"></img></center>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-3">
                        ...
                        <br><br><br><br><br>
                        <img src="chairman.jpg" class="imageDiv">
                    </div>
                </div>   
            </div>
        </div>
                ...
                <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3">
                            ...
                            <img src="vice-chairman.jpg" class="imageDiv" style="float: center">
                        </div>
                        <div class="col-lg-9">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-3">
                        ...
                        <br><br>
                        <img src="ranjan.jpg" class="imageDiv">
                    </div>
                </div>   
            </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3">
                        ...
                        <img src="award1.jpg" class="rounded-circle" width="304" height="236" style="border: solid 1px"><br><br><br>
                    </div>
                </div>   
            </div>
            <!-- </div> -->
                ...
                <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3">
                            ...
                            <img src="award2.jpg" class="rounded-circle" width="250" height="236  style="border: solid 1px">
                        </div>
                        <div class="col-lg-9">
                            <div id="paragraph3">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-3">
                        ...
                        <img src="award3.jpg" class="rounded-circle" width="304" height="236"  style="border: solid 1px"><br><br><br>
                    </div>
                </div>   
            </div>
                ...
                <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3">
                            ...
                            <img src="award4.jpg" class="rounded-circle" width="250" height="236"  style="border: solid 1px">
                        </div>
                        <div class="col-lg-9">
                            <div id="paragraph3">
                                <br>
